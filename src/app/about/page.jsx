      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          ...
          <div className="text-md text-gray-500 flex flex-col gap-6">
            <p>
              Welcome to Personal Blog! Created by myself, this blog serves as a
              personal platform to share his insights and ideas with the world.
              I am an enthusiastic developer who enjoys writing about
            ...
            <p>
              ...
              engineering, and programming languages. Developer is continually
